...
if (/nsis/i.test(builder)) throw new Error("NSIS packaging is disabled for Ravel local release");
if (!/target:\s*\n\s*- dir/.test(builder)) throw new Error("Windows unpacked dir target is required");
const manifestPath = process.env.RAVEL_RELEASE_MANIFEST ?? process.env.OMEGA_RELEASE_MANIFEST;
